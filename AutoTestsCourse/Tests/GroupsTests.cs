...
namespace AddressBookAutotests.Tests
{
    ...
    public class GroupsTest : TestWithAuth
    {
        ...
        public void AddGroupTest(GroupData groupData)
        {
        ...
        public void AddGroupTestCsv(GroupData groupData)
        {
            Manager.Scenarios.AddGroup(groupData);
        }
        ...
        public void AddGroupTestXml(GroupData groupData)
        {
            Manager.Scenarios.AddGroup(groupData);
        }
        ...
        public void AddGroupTestJson(GroupData groupData)
        {
            Manager.Scenarios.AddGroup(groupData);
        }
